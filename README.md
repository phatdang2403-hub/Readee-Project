...
|:-:|:------------------------|:-------:|:--------------------------------------------------------------|
| 1 | **Dương Minh Kha** | Leader  | Điều phối; Technical Architect; Review chất lượng sản phẩm    |
| 2 | **Đỗ Liên Thịnh** | Member  | Data Engineer: Thu thập, làm sạch & chuẩn hóa dữ liệu         |
| 3 | **Huỳnh Đằng Phát** | Member  | AI Engineer: Training mô hình CEFR, Embedding, Classification |
| 4 | **Lê Thanh Hằng** | Member  | Frontend App, UI/UX, giao diện Notion App                     |
| 5 | **Trần Thị Khánh Linh** | Member  | Business Analyst: Use-case, user flow, giá trị sản phẩm       |
| 6 | **Bùi Lê Đức Đạt** | Member  | AI Pipeline + Evaluation: SHAP, đánh giá mô hình              |
